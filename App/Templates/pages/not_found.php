...
<div class="not_found container-sm">
  <div>
  ...
  <div>
    <h1>404</h1>
    <p>Мы не нашли страницу, которую вы искали. Возможно, она была перемещена, или ее просто не существует.</p>
    <?= $this->ui('btn', ['src' => '/', 'classes' => 'primary fill', 'text' => 'Вернуться на главную']) ?>
  </div>
  <!-- <h1>404</h1>
